...
namespace AppBE.Repositories
{
    public class ProductRepository : IRepository<Product>
    {
        ...
        {
            string query = @"SELECT ProductID, Name, Brand, Description, ImageURL FROM dbo.PRODUCTS";
        ...
        {
            string query = @"SELECT ProductID, Name, Brand, Description, ImageURL FROM dbo.PRODUCTS WHERE ProductID = @ProductID";
